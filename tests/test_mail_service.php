...
// Teste usando MailService (se existir)
echo "\n\n=== TESTE COM MAILSERVICE ===\n";
try {
    if (class_exists('MailService')) {
        ...
        if ($result) {
            echo "MailService funcionou!\n";
        } else {
            echo "MailService falhou: " . $mailService->getLastError() . "\n";
        }
    } else {
        echo "Classe MailService não encontrada!\n";
    }
} catch (Exception $e) {
